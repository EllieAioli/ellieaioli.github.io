...
<head>
	...
	<script src="files/autosize.min.js"></script>
...
<body>
	...
	<div style="display: flex;padding-top:7px;">
		<div class="flex-box" style="width:50%">
			...
			<div class="menu-item">
				<a id="btnBorders" title="Hide map borders" class="btn btn-sm btn-outline-secondary" data-toggle="button" aria-pressed="true"><i class="fa fa-eye-slash" aria-hidden="true"></i> Borders</a>
			</div>
			<div class="menu-item">
				<a id="btnHideControls" title="Hide move, resize, etc. icons" class="btn btn-sm btn-outline-secondary" data-toggle="button" aria-pressed="true"><i class="fa fa-eye-slash" aria-hidden="true" ></i> Controls</a>
			</div>
			<div class="menu-item">
				<span class="text-light" style="font-size: 12pt;">&#9679;</span>
			</div>
			<div class="menu-item">
				<a id="btnClear" title="Delete all map markers"class="confirm btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i> Markers</a>
			</div>
		</div>
		<div class="flex-box" style="width:50%">
			<!--<div class="menu-item">
				<a id="btnAddBuilding" class="btn btn-sm btn-primary" title="Add a new, blank mission"><i class="fa fa-plus" aria-hidden="true"></i> New</a>
			</div>-->
			<div class="menu-item">
	...
	<div class="row">
		<!-- map col -->
		<div class="" style="display:flex; flex-grow: 0;">
			<div class="info-panel dragging">
				<div>
					<span class="text-light">Missions: </span><span id="lblNumMissions" class="text-light">-</span><br>
					<span class="text-success">Cash: $</span><span id="lblCash" class="text-success">-</span><br>
	    			<span class="text-warning">EXP: </span><span id="lblEXP" class="text-light">-</span>
	    		</div>
	    		<div>
    				<textarea id="info-textarea" class="text-light" style="border: none;background: transparent;min-height: 25px;" rows="1" placeholder="Info.."></textarea>
    			</div>
			</div>
			<div>
				<div id="tableDiv">
				...
				<div class="coords-panel">
					<input id="lblCoords" type="text" value="0-0">
				</div>
			</div>
		</div>
		...
		<!-- mission col -->
		<div class="col px-6">
			<div class="missionBox" style="column-count:2">
					...
					<div class="row">
						<div class="col">
							<div class="dragging">
								...
								<div>
								  	<textarea class="draggyBuilding" placeholder="Building" rows="1"></textarea>
							 	</div>
					 		</div>
					 	</div>
				 		<div class="col px-2">
